...
function setupEventListeners() {
    ...
    // Sembunyikan dropdown profil jika klik di luar area profil
...
// Toggle kemunculan dropdown profil popover
function toggleProfileDropdown(event) {
    event.stopPropagation(); // Cegah propagasi klik ke dokumen
